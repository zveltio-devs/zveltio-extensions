...
-- zvd_api_custom_docs: slug is unique per company, not per instance.
UPDATE zvd_api_custom_docs SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_api_custom_docs DROP CONSTRAINT IF EXISTS zvd_api_custom_docs_slug_key;
ALTER TABLE zvd_api_custom_docs ADD CONSTRAINT zvd_api_custom_docs_slug_key UNIQUE (tenant_id, slug);
