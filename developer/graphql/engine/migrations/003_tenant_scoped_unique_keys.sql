...
-- zvd_graphql_field_policies: collection + field is unique per company, not per instance.
UPDATE zvd_graphql_field_policies SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_graphql_field_policies DROP CONSTRAINT IF EXISTS zvd_graphql_field_policies_collection_field_key;
ALTER TABLE zvd_graphql_field_policies ADD CONSTRAINT zvd_graphql_field_policies_collection_field_key UNIQUE (tenant_id, collection, field);

-- zvd_graphql_persisted_queries: name is unique per company, not per instance.
UPDATE zvd_graphql_persisted_queries SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_graphql_persisted_queries DROP CONSTRAINT IF EXISTS zvd_graphql_persisted_queries_name_key;
ALTER TABLE zvd_graphql_persisted_queries ADD CONSTRAINT zvd_graphql_persisted_queries_name_key UNIQUE (tenant_id, name);
