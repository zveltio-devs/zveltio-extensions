...
-- zvd_db_connection_profiles: name is unique per company, not per instance.
UPDATE zvd_db_connection_profiles SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_db_connection_profiles DROP CONSTRAINT IF EXISTS zvd_db_connection_profiles_name_key;
ALTER TABLE zvd_db_connection_profiles ADD CONSTRAINT zvd_db_connection_profiles_name_key UNIQUE (tenant_id, name);
