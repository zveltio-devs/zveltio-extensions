...
ALTER TABLE IF EXISTS zvd_expense_reimbursements ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_mileage_entries ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_mileage_entries ALTER COLUMN employee_id TYPE TEXT;
ALTER TABLE IF EXISTS zvd_per_diem_entries ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_per_diem_entries ALTER COLUMN employee_id TYPE TEXT;
