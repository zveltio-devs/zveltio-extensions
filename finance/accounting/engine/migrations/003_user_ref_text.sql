...
ALTER TABLE IF EXISTS zvd_budgets ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_cost_centers ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_fiscal_years ALTER COLUMN closed_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_recurring_journals ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_tax_reports ALTER COLUMN created_by TYPE TEXT;
