...
-- zvd_quotes: number is unique per company, not per instance.
UPDATE zvd_quotes SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_quotes DROP CONSTRAINT IF EXISTS zvd_quotes_number_key;
ALTER TABLE zvd_quotes ADD CONSTRAINT zvd_quotes_number_key UNIQUE (tenant_id, number);
