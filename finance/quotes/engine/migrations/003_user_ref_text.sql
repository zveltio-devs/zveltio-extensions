...
ALTER TABLE IF EXISTS zvd_quote_approvals ALTER COLUMN approved_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_quote_approvals ALTER COLUMN requested_by TYPE TEXT;
