...
-- zvd_crm_custom_fields: entity_type + name is unique per company, not per instance.
UPDATE zvd_crm_custom_fields SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_crm_custom_fields DROP CONSTRAINT IF EXISTS zvd_crm_custom_fields_entity_type_name_key;
ALTER TABLE zvd_crm_custom_fields ADD CONSTRAINT zvd_crm_custom_fields_entity_type_name_key UNIQUE (tenant_id, entity_type, name);
