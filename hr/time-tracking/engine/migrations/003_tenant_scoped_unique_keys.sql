...
-- zvd_time_entry_tags: name is unique per company, not per instance.
UPDATE zvd_time_entry_tags SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_time_entry_tags DROP CONSTRAINT IF EXISTS zvd_time_entry_tags_name_key;
ALTER TABLE zvd_time_entry_tags ADD CONSTRAINT zvd_time_entry_tags_name_key UNIQUE (tenant_id, name);
