...
ALTER TABLE IF EXISTS zvd_performance_reviews ALTER COLUMN reviewer_id TYPE TEXT;
ALTER TABLE IF EXISTS zvd_salary_history ALTER COLUMN changed_by TYPE TEXT;
