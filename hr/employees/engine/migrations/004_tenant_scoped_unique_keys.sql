...
-- zvd_employees: employee_number is unique per company, not per instance.
UPDATE zvd_employees SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_employees DROP CONSTRAINT IF EXISTS zvd_employees_employee_number_key;
ALTER TABLE zvd_employees ADD CONSTRAINT zvd_employees_employee_number_key UNIQUE (tenant_id, employee_number);
