...
ALTER TABLE IF EXISTS zv_ro_purchase_orders ALTER COLUMN approved_by TYPE TEXT;
ALTER TABLE IF EXISTS zv_ro_purchase_orders ALTER COLUMN created_by TYPE TEXT;
