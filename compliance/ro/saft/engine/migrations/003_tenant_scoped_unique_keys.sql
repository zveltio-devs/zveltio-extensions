...
-- zv_saft_accounts: code is unique per company, not per instance.
UPDATE zv_saft_accounts SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zv_saft_accounts DROP CONSTRAINT IF EXISTS zv_saft_accounts_code_key;
ALTER TABLE zv_saft_accounts ADD CONSTRAINT zv_saft_accounts_code_key UNIQUE (tenant_id, code);
