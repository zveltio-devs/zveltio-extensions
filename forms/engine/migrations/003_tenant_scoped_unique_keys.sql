...
-- zv_forms: slug is unique per company, not per instance.
UPDATE zv_forms SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zv_forms DROP CONSTRAINT IF EXISTS zv_forms_slug_key;
ALTER TABLE zv_forms ADD CONSTRAINT zv_forms_slug_key UNIQUE (tenant_id, slug);
