...
-- zvd_saml_attribute_mappings: saml_attribute is unique per company, not per instance.
UPDATE zvd_saml_attribute_mappings SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_saml_attribute_mappings DROP CONSTRAINT IF EXISTS zvd_saml_attribute_mappings_saml_attribute_key;
ALTER TABLE zvd_saml_attribute_mappings ADD CONSTRAINT zvd_saml_attribute_mappings_saml_attribute_key UNIQUE (tenant_id, saml_attribute);
