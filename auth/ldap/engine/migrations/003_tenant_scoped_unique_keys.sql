...
-- zvd_ldap_group_mappings: ldap_group is unique per company, not per instance.
UPDATE zvd_ldap_group_mappings SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_ldap_group_mappings DROP CONSTRAINT IF EXISTS zvd_ldap_group_mappings_ldap_group_key;
ALTER TABLE zvd_ldap_group_mappings ADD CONSTRAINT zvd_ldap_group_mappings_ldap_group_key UNIQUE (tenant_id, ldap_group);

-- zvd_ldap_ip_allowlist: cidr is unique per company, not per instance.
UPDATE zvd_ldap_ip_allowlist SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_ldap_ip_allowlist DROP CONSTRAINT IF EXISTS zvd_ldap_ip_allowlist_cidr_key;
ALTER TABLE zvd_ldap_ip_allowlist ADD CONSTRAINT zvd_ldap_ip_allowlist_cidr_key UNIQUE (tenant_id, cidr);
