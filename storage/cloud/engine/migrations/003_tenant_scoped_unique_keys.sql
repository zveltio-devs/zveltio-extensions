...
-- zv_cloud_file_versions: file_key + version is unique per company, not per instance.
UPDATE zv_cloud_file_versions SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zv_cloud_file_versions DROP CONSTRAINT IF EXISTS zv_cloud_file_versions_file_key_version_key;
ALTER TABLE zv_cloud_file_versions ADD CONSTRAINT zv_cloud_file_versions_file_key_version_key UNIQUE (tenant_id, file_key, version);
