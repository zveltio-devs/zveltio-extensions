...
-- zvd_quality_sla_targets: collection is unique per company, not per instance.
UPDATE zvd_quality_sla_targets SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_quality_sla_targets DROP CONSTRAINT IF EXISTS zvd_quality_sla_targets_collection_key;
ALTER TABLE zvd_quality_sla_targets ADD CONSTRAINT zvd_quality_sla_targets_collection_key UNIQUE (tenant_id, collection);
