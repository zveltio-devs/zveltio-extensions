...
-- zvd_incoming_webhooks: endpoint_path is unique per company, not per instance.
UPDATE zvd_incoming_webhooks SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_incoming_webhooks DROP CONSTRAINT IF EXISTS zvd_incoming_webhooks_endpoint_path_key;
ALTER TABLE zvd_incoming_webhooks ADD CONSTRAINT zvd_incoming_webhooks_endpoint_path_key UNIQUE (tenant_id, endpoint_path);
