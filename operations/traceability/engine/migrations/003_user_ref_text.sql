...
ALTER TABLE IF EXISTS trace_dispatches ALTER COLUMN confirmed_by TYPE TEXT;
ALTER TABLE IF EXISTS trace_lots ALTER COLUMN received_by TYPE TEXT;
ALTER TABLE IF EXISTS trace_lots ALTER COLUMN released_by TYPE TEXT;
ALTER TABLE IF EXISTS trace_movements ALTER COLUMN performed_by TYPE TEXT;
ALTER TABLE IF EXISTS trace_production_orders ALTER COLUMN operator_id TYPE TEXT;
