...
ALTER TABLE IF EXISTS zvd_asset_insurance ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_asset_revaluations ALTER COLUMN created_by TYPE TEXT;
ALTER TABLE IF EXISTS zvd_asset_transfers ALTER COLUMN transferred_by TYPE TEXT;
