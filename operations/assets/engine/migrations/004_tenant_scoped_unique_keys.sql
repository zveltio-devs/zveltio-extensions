...
-- zvd_assets: code is unique per company, not per instance.
UPDATE zvd_assets SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_assets DROP CONSTRAINT IF EXISTS zvd_assets_code_key;
ALTER TABLE zvd_assets ADD CONSTRAINT zvd_assets_code_key UNIQUE (tenant_id, code);
