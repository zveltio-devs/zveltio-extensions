...
ALTER TABLE IF EXISTS zvd_pos_cash_movements ALTER COLUMN cashier_id TYPE TEXT;
ALTER TABLE IF EXISTS zvd_pos_held_orders ALTER COLUMN cashier_id TYPE TEXT;
