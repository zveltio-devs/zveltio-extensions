...
-- zvd_pos_orders: order_number is unique per company, not per instance.
UPDATE zvd_pos_orders SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zvd_pos_orders DROP CONSTRAINT IF EXISTS zvd_pos_orders_order_number_key;
ALTER TABLE zvd_pos_orders ADD CONSTRAINT zvd_pos_orders_order_number_key UNIQUE (tenant_id, order_number);
