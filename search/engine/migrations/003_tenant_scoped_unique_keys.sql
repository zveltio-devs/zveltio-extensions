...
-- zv_search_indexes: collection is unique per company, not per instance.
UPDATE zv_search_indexes SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zv_search_indexes DROP CONSTRAINT IF EXISTS zv_search_indexes_collection_key;
ALTER TABLE zv_search_indexes ADD CONSTRAINT zv_search_indexes_collection_key UNIQUE (tenant_id, collection);
