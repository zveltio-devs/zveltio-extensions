...
-- zv_collection_publish_settings: collection is unique per company, not per instance.
UPDATE zv_collection_publish_settings SET tenant_id = '00000000-0000-0000-0000-000000000001'::uuid WHERE tenant_id IS NULL;
ALTER TABLE zv_collection_publish_settings DROP CONSTRAINT IF EXISTS zv_collection_publish_settings_collection_key;
ALTER TABLE zv_collection_publish_settings ADD CONSTRAINT zv_collection_publish_settings_collection_key UNIQUE (tenant_id, collection);
